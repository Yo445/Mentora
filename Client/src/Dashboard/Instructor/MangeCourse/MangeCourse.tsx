            ...
            .then((resp) => {
                if (Array.isArray(resp.data)) {
                    ...
                    setCourseState({
                        ...courseState,
                        loading: false,
                        err: "Unexpected data format from the server",
                    });
        ...
        <>
            ...
            {courseState.err && showAlert && (
                <div className="mt-10 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mt-4" role="alert">
                    ...
                    <button
                        onClick={() => setShowAlert(false)} // Hide alert when clicked
                        className="absolute top-0 mb-1 right-0 px-4 py-3 text-red-500 font-bold text-xl"
                    >
                        x
                    </button>
